 ...
 */
import com.toimemetusaiscestnousquonfaitlesmeilleursjeux.madafackainvaders.MadafackaInvadersGame;
...
public class AccelerometerHandler implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        final int[] as = ACCELEROMETER_AXIS_SWAP[MadafackaInvadersGame.screenRotation];
